...
export const MESSAGES = {
  ...
  auth: {
    ...
    scriptsBlocked: 'Google sign-in could not load. Your browser or an ad blocker may be blocking it. Try disabling ad blockers for this site.',
  },
  consent: {
    title: 'Before you sign in',
    dataAccess: 'This app only accesses a hidden app folder in your Google Drive. It cannot see or modify any of your personal files.',
    unverifiedWarning: 'Google will show an "unverified app" warning because this is a personal project, not a verified business app. To proceed:',
    unverifiedStep1: 'Click Advanced',
    unverifiedStep2: 'Click "Go to Personal Finance App (unsafe)"',
    dataOwnership: 'Your financial data is stored exclusively in YOUR Google Drive — not on any server the developer controls.',
    privacy: 'No data is shared with third parties. There is no backend, no analytics server, no ads. The full source code is public on GitHub.',
    continueButton: 'I understand, continue to Google',
    cancelButton: 'Cancel',
  },
  csv: {
